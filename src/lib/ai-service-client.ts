...
export const aiService = {
  ...
  generateCacheKey: function(params: Record<string, any>): string {
  ...
  generateExplanation: async function(params: ExplanationParams): Promise<string> {
  ...
  chat: async function(messages: ChatMessage[]): Promise<string> {
  ...
  chatWithRetry: async function(messages: ChatMessage[], retryCount = 0): Promise<string> {
    try {
  ...
  // Translate text
  translate: async function(params: TranslationParams): Promise<string> {
  ...
  getFallbackExplanation: function(params: ExplanationParams): string {
